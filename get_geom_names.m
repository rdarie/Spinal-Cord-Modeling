...
tissue_info = mphgetselection(fem.selection('sel1'));
...
wm_info = mphgetselection(fem.selection('sel6'));
...
csf_info = mphgetselection(fem.selection('sel5'));
