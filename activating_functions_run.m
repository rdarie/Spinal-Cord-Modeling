...
comsol_files = {'5M mesh\one_root_um_altel','5M mesh\move_root_um_altel'};

axon_files = {'axon_centers.csv','moved_axon_centers.csv'};
...
%     'Root not present'...
%     };
% comsol_files = {'5M mesh\one_root_um','5M mesh\no_root_um',...
%     '5M mesh\move_root_um','5M mesh\no_root_um'};
% 
% axon_files = {'axon_centers.csv','axon_centers.csv',...
%     'moved_axon_centers.csv','moved_axon_centers.csv'};
%  comsol_files = {...
%      'move_root_um', ...
%      'no_root_um'...
%      };
